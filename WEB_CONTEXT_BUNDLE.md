...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-bfca1ac71a3436d7"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Number theory, Analytic number theory; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-bfca1ac71a3436d7",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-bfca1ac71a3436d7",
        "url": "https://en.wikipedia.org/wiki/Divisor_summatory_function#Piltz_divisor_problem"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Piltz divisor problem on bounding ${\\textstyle \\Delta _{k}(x)=D_{k}(x)-xP_{k}(\\log(x))$",
      "version": 1
    },
    "title": "Piltz divisor problem",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "fcdc9aa03f0df7f35121c233047c07a32993c9eda96e9953da09d0fe1d9a17a7"
}
```
